...
export const IMedidaSelecionadaPlanoAlimentarSchema = z.object({
  ...
  total: z
    .number()
    .positive("O total da medida selecionada deve ser maior que zero"),
...
export const IRefeicaoPlanoAlimentarSchema = z.object({
  ...
  horario: z
    ...
    .regex(
      ...
      "Horario invalido. Use o formato HH:mm entre 00:00 e 23:59",
    ),
  observacoes: z.string().optional(),
  alimentos: z
    .array(IAlimentoPlanoAlimentarSchema)
...
export const IPlanoAlimentarSchema = z.object({
  ...
  refeicoes: z
    .array(IRefeicaoPlanoAlimentarSchema)
    .min(1, "O plano alimentar deve ter pelo menos 1 refeicao"),
});
...
export type IPlanoAlimentarPersistido = z.infer<
  typeof IPlanoAlimentarPersistidoSchema
>;
...
export const IAtualizarPlanoAlimentarInputSchema =
  IPlanoAlimentarInputSchema.partial()
    .strict()
